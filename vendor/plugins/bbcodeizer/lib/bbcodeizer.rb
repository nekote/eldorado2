module BBCodeizer  
  class << self
    ...
    #:nodoc:
    Tags = {
      :gs_only               => [ /\[gs\](.+?)\[\/gs\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: #1E90FF"><strong>&#9835; Grooveshark: \1 &#9835;</strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><object width="250" height="40"> <param name="movie" value="http://grooveshark.com/songWidget.swf" /><param name="wmode" value="window" /><param name="allowScriptAccess" value="always" /> <param name="flashvars" value="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" /> <embed src="http://grooveshark.com/songWidget.swf" type="application/x-shockwave-flash" width="250" height="40" flashvars="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" allowScriptAccess="always" wmode="window" /></object></div>'],
      :gs_eql_no_text        => [ /\[gs=(.+?)\]\[\/gs\]/i, '<object width="250" height="40"> <param name="movie" value="http://grooveshark.com/songWidget.swf" /><param name="wmode" value="window" /><param name="allowScriptAccess" value="always" /> <param name="flashvars" value="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" /> <embed src="http://grooveshark.com/songWidget.swf" type="application/x-shockwave-flash" width="250" height="40" flashvars="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" allowScriptAccess="always" wmode="window" /></object>'],
      :gs_eql_with_text      => [ /\[gs=(.+?)\](.+?)\[\/gs\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: #1E90FF"><strong>&#9835; Grooveshark: \2 &#9835;</strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><object width="250" height="40"> <param name="movie" value="http://grooveshark.com/songWidget.swf" /><param name="wmode" value="window" /><param name="allowScriptAccess" value="always" /> <param name="flashvars" value="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" /> <embed src="http://grooveshark.com/songWidget.swf" type="application/x-shockwave-flash" width="250" height="40" flashvars="hostname=cowbell.grooveshark.com&songIDs=\1&style=water&p=0" allowScriptAccess="always" wmode="window" /></object></div>'],
...
#      :im_sans_text          => [ /\[im\](.+?)\[\/im\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: purple"><strong>Image: </strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><img src="\1" alt="\1" /></div>' ],
#      :im_with_text          => [ /\[im=(.+?)\](.+?)\[\/im\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: purple"><strong>Image: \1</strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><img src="\2" alt="\1" /></div>' ],
...
#      :yt_sans_text          => [ /\[yt\](.+?)youtube.com\/watch\?v=(.+?)\[\/yt\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: green"><strong>YouTube: </strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/\2"></param><embed src="http://www.youtube.com/v/\2" type="application/x-shockwave-flash" width="425" height="350"></embed></object></div>'],
#      :yt_with_text          => [ /\[yt=(.+?)\](.+?)youtube.com\/watch\?v=(.+?)\[\/yt\]/i, '<a href="#" class="hide-link" onclick="$(\'_RANDOM_ID_\').toggle(); return false;"><span style="color: green"><strong>YouTube: \1</strong></span></a><div id="_RANDOM_ID_" class="hide" style="display:none;"><object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/\3"></param><embed src="http://www.youtube.com/v/\3" type="application/x-shockwave-flash" width="425" height="350"></embed></object></div>'],
      :youtube_amp_v         => [ /\[youtube\](.+?)youtube.com\/watch\?(.+?)\&amp;v=(.+?)\[\/youtube\]/i, '<object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/\3&\2"></param><embed src="http://www.youtube.com/v/\3&\2" type="application/x-shockwave-flash" width="425" height="350"></embed></object>' ],
      :youtube_sans_text     => [ /\[youtube\](.+?)youtube.com\/watch\?v=(.+?)\[\/youtube\]/i, '<object width="425" height="350"><param name="movie" value="http://www.youtube.com/v/\2"></param><embed src="http://www.youtube.com/v/\2" type="application/x-shockwave-flash" width="425" height="350"></embed></object>' ],
    ...
    TagList = [ :literal,
                :gs_only, :gs_eql_no_text, :gs_eql_with_text, 
                :grooveshark, 
                :center, :sup, :sub, :br, :hr, :table, :tbl, :th,
                :tr, :td, :bold, :italic, :underline, :del, :strike, :email_with_name, 
                :email_sans_name, :url_with_title, :url_sans_title, 
#                :im_sans_text, :im_with_text,
                :image, :size, :color, :code, :quote,
#                :yt_sans_text, :yt_with_text,
                :youtube_amp_v,
                :youtube_sans_text,
                :googlevid, :flash, :spoiler, :nsfw, :hide, :mp3, 
    ...
    def bbcodeize(text)
      ...
      TagList.each do |tag|
        ...
        # and any of the 'hide' versions, such as grooveshark and youtube
        @random_id = random_string
        # requires pair of _RANDOM_ID_ and provides same value, twice
